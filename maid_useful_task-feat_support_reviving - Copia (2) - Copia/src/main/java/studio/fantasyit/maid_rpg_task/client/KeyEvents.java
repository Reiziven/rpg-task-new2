...
import studio.fantasyit.maid_rpg_task.network.MaidAllowHandleVehicle;
import studio.fantasyit.maid_rpg_task.network.Network;

import static studio.fantasyit.maid_rpg_task.client.KeyMapping.KEY_SWITCH_VEHICLE_CONTROL;

@Mod.EventBusSubscriber(modid = MaidRpgTask.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
